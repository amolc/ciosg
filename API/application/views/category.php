											...
											<div class="clsForm">
												<div class="row">
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="Enter Category Name" id="company_name"class="form-control" name="company_name">
													</div>
																 
													<div style="margin-bottom:15px;" class="col-md-6">
													<select name="" style="width:200px; height:40px">
														<option>High</option>
														<option>Low</option>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="clsLine"></div>
						<br>
						<a href="manage/add_category" class="btn btn-primary">Add New Category</a><br><br>
			<table class="table table-bordered responsive-table">
			  ...
			  <tbody>
				<? $res=mysql_query("select catID,cat_name,priority from sg_category");
				while($row=mysql_fetch_array($res)) {?>
				<tr>
					<td><?=$row['catID']?></td>
