			...
			<div id="sidebar-wrapper">
				<div id="MainMenu">
					  <div class="list-group panel">
						...
						<a data-parent="#MainMenu" data-toggle="collapse" class="edit_List1 list-group-item list-group-item-primary collapsed" href="manage/manage_company">Manage Company</a>
