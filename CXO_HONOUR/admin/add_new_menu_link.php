			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$status = "pending";
							...
							$sql   = "insert into menu(menu_name,menu_link) values ('$title','$link')";
							$query = mysql_query($sql) or dei(mysql_error());
							if($query)
							{
								
								echo'<script>window.location.replace("admin_menu.php?add=ok");</script>';
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<select style="margin-left: 21px;" id='page_type' name="link" class="form-control">
