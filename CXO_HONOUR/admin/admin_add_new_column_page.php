			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$type = "column";
							...
							$sql   = "insert into pages(page_name,page_description,left_column,page_type,page_insert_date) values ('$page_title','$Page_description','$left','$type','$page_insert_date')";
							$query = mysql_query($sql);
							if($query)
							{
								
								echo'<script>window.location.replace("admin_column_pages.php?add=ok");</script>';
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
                                                            <textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview " name="left_column"  id="left_column" required></textarea>
