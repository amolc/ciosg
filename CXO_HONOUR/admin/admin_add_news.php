...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					...
					<li class="">
							<strong><a href="admin_news.php">News</a> </strong>
					</li>
					<li class="active">
	...
	<div class="col-md-12">
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit"){
				...
				&& ($_FILES["file"]["size"] < 9900000000000000000000)
				&& in_array($extension, $allowedExts))
				  ...
				  if ($_FILES["file"]["error"] > 0)
					...
					// if (file_exists("upload/news/" . $_FILES["file"]["name"]))
					  // {
					...
					// else
					  ...
					  "upload/news/" .$img_name );
					  echo "Stored in: " . "CXO_HONOUR/upload/news/" . $img_name;
					  //}
					}
					///
				...
				$current_date = date("m/d/Y", $today_date);
					...
					if($query)
					{
						echo'<script>window.location.replace("admin_news.php?add=ok");</script>';
					}
					else 
					{
						echo "error";
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
							<label for="field-ta" class="col-sm-3 control-label">Tags </label>
					
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="tags" id="tour_overview" required></textarea>
