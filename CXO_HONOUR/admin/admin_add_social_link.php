	...
	<div class="col-md-12">
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit"){
				...
				$social_name = mysql_real_escape_string($_POST['social_name']);
				$social_address = mysql_real_escape_string($_POST['social_address']);
			
				$social_image = $_FILES["file"]["name"];

				$today_date = mktime(0,0,0,date("m"),date("d"),date("Y"));
				$current_date = date("m/d/Y", $today_date);
				
					$sql   = "insert into social_link(social_name,social_address,advisory_image,social_insert_date) values('".$social_name."','".$social_address."','".$social_image."','".$current_date."')";
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Social Name</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="social_name"  placeholder="" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Social Address</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="social_address"  placeholder=" " required>
						</div>
					</div>
					<div class="form-group">
