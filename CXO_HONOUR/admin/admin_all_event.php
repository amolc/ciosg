...
echo '<h2 style="color:red">Event Deleted</h2>'; 
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green">Event Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Event Added</h2>'; 
}
 ?>
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td>'.$row['event_held_date'].'</td>
					<td>'.$row['event_description'].'</td>
					<td><a href="admin_edit_event.php?id='.$row['event_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_event_delete.php?id='.$row['event_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
