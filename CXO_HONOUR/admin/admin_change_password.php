			...
			<?php
				...
				$result = mysql_query("SELECT id FROM tour");
										...
										// {
											...
											// echo "<h2>your payment status shows unpaid now please pay to continue</h2><a href='http://apps.day7.co/tourbookings/admin/payment_booking.php'><button>Pay Now</button></a> ";
										// }
