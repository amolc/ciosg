<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$result = mysql_query("SELECT * FROM about WHERE abt_type='overview'");
					...
					if($_POST['submit'] == 'submit')
					{
                        ...
                        $sql   = "Update about SET
						   abt_description = '$abt_description'
							where abt_type = 'overview'
							";
							$query = mysql_query($sql) or die (mysql_error());
							if($query)
							{
								echo'<script>window.location.replace("admin_cio_choice_overview.php?edit=ok");</script>';
