		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="">
					<td>'.$row['contact_us_first_name'].'</td>
					<td>'.$row['contact_us_last_name'].'</td>
					<td>'.$row['contact_us_email'].'</td>
					<td>'.$row['contact_us_im'].'</td>
					<td>'.$row['contact_us_message'].'</td>
					<td>'.$row['contact_us_insert_date'].'</td>
					<td>
						<a id="'.$row['contact_us_id'].'" class="delete">
