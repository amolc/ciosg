...
<script type="text/javascript">//<![CDATA[
  bkLib.onDomLoaded(function() {
        ...
        new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough','subscript','superscript','left','center','right','justify','html','link','unlink']}).panelInstance('left_column');
...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="admin_column_pages.php">Column Pages</a></strong>
				</li>
				<li class="active">
					<strong>Edit</strong>
				</li>
			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$left = addslashes($_POST['left_column']);
						$Page_id = mysql_real_escape_string($_POST['id']);
							...
							if($query)
							{								
								echo'<script>window.location.replace("admin_column_pages.php?edit=ok");</script>';								
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="page_title" id="title" value="<?php echo $row['page_name']; ?>" />
							</div>
						</div>
						
						<div class="form-group">
							<label for="field-ta" class="col-sm-3 control-label">Right Column</label>
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
                                                        ...
                                                        include("plugin/fckeditor/fckeditor.php") ;
                                                          ...
                                                          $oFCKeditor->Value		= $row['page_description'];
                                                          $oFCKeditor->Create() ;
                                                          ?>
						...
						<div class="form-group">
							<label for="field-ta" class="col-sm-3 control-label">Left Column</label>
					
							<div class="form-group" style="width: 572px;margin-left: 272px;">
								
							
                                                            <textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="left_column"  id="left_column" required><?php echo $row['left_column']; ?></textarea>
                                                        </div>
