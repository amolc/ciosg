<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$result = mysql_query("SELECT * FROM event_landing_page WHERE page_id=$id");
			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$Page_id = mysql_real_escape_string($_POST['id']);
							...
							$sql   = "Update event_landing_page SET 
							...
							if($query)
							{								
								echo'<script>window.location.replace("admin_event_pages.php?edit=ok");</script>';								
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="page_title" id="title" value="<?php echo $row['page_title']; ?>" />
							</div>
						</div>
...
<!--								<textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="Page_description" id="tour_overview" required><?php //echo $row['page_description']; ?></textarea>-->
							 <?php
