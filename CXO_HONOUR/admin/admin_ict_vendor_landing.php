...
<div style="float:right"><a href="admin_ict_vendor_landing_add.php"><button type="button" class="btn btn-success">Add New </button></a></div>
<br />
<br />
<?php
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td>'.$row['id'].'</td>
					<td>'.$row['title'].'</td>					
					<td><a href="admin_ict_vendor_landing_edit.php?id='.$row['id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_ict_vendor_landing_delete.php?id='.$row['id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
