	...
	<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<a href="admin_dashboard.php"><i class="entypo-home"></i>Home</a>
					...
					<li class="active">
							<strong><?php echo $row['menu_name']; ?></strong>
					</li>
					
					</ol>
			
<h2><?php echo $row['menu_name']; ?></h2>
<div style="float:right"><a href="add_new_sub_menu_link.php?id=<?php echo $row['menu_id']; ?>"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />

<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Sub Menu Deleted</h2>';
}
if(isset($_REQUEST['add'])){
echo '<h2 style="color:green;">Sub Menu Added</h2>';
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green;">Sub Menu Updated</h2>'; 
}
...
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['sub_id'].'">
				   
									
					<td>'.$row['sub_name'].'</td>
					<td>'.$row['sub_link'].'</td>
					<td><a href="admin_edit_sub_menu.php?id='.$row['sub_id'].'&pid='.$id.'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_sub_menu.php?id='.$row['sub_id'].'&pid='.$id.'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left">
							Delete
						</a>
					</td>
				</tr>
