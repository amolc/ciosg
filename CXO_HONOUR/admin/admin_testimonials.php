<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$result = mysql_query("SELECT * FROM about WHERE abt_type='testimonials'");
					...
					if($_POST['submit'] == 'submit')
					{
                        ...
                        $sql   = "Update about SET
						   abt_description = '$abt_description'
							where abt_type = 'testimonials'
							";
							$query = mysql_query($sql) or die (mysql_error());
							if($query)
							{
								echo'<script>window.location.replace("admin_testimonials.php?edit=ok");</script>';
