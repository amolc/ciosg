...
?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="massage_board.php">Message</a></strong>
				</li>
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$message = addslashes($_POST['message']);
							...
							$sql   = "update message_board set message = '$message'";
							$query = mysql_query($sql);
							if($query)
							{
								
								echo'<script>window.location.replace("massage_board.php?add=ok");</script>';
