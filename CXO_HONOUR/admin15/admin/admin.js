...
function accept_vendor(vid)
{
		...
		$.getJSON('http://www.globalprompt.org/sg/cio/category/accept_vendor/?callback=?' ,"vid="+vid+"",function(array) {
				$.post("vendor_activation.php" ,{'name':array.email_data.firstname ,'email':array.email_data.emailID,'reg_type':array.email_data.registration_type,'pass':array.email_data.password}).done(function( data ) {   
