							...
							<div id="add_item_result" class="alert-success form-control" style="display:none;"></div><br>
											...
											<div class="clsForm"> 
												<div class="row">
													...
													<div style="margin-bottom:15px;" class="col-md-4" >
														<label for="exampleInputEmail1">Enter Item Price</label>
														<input type="text"  id="item_price" style="height:50px;" placeholder="Enter Item Price" class="form-control form-font">
							...
							<div id="edit_item_result" class="alert-success form-control" style="display:none;"></div><br>
											...
											<div class="clsForm"> 
												...
												<div class="row">
													...
													<div style="margin-bottom:15px;" class="col-md-4" >
														<label for="exampleInputEmail1">Enter Item Price</label>
														<input type="text"  id="edit_item_price" style="height:50px;" placeholder="Enter Item Price" class="form-control form-font">
		...
		<div id="admin_div_22" style="display:none;">
				<div class="container-fluid">
					<div class="clsIn_cont">
						...
						<div class="row" id="rlistloading">
							<div class="col-md-12">
							<div id="pvlist" class="alert-success form-control" style="display:none;"></div><br>
