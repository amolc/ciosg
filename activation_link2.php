<?php 
	...
	function email_to_cio_signup($registration_name , $registration_email ,$web_url,$registration_type,$pass,$str) {
		...
		$confirm_url="<a  href='http://www.cxohonour.com/accepted.php?id=".$str."'>click here to activate your account</a>";
		...
		<div style=" height:870px; padding:25px; background:#eaeaea">
														<div style="float:left; width:100%; margin:0px 0px 25px 0px; background:white; box-shadow:0px 2px 5px #7d7c7c;">
															<div style=" float:left; width:100%; height:225px; background:url(http://www.cxohonour.com/images/cio_choice_head_bg.png) repeat-x  center top;">
																<div style=" width:210px;height: 225px; margin:0 auto;">
																<a href="#" style="height:245px;"><img src="http://www.cxohonour.com/images/logo3.png" alt="" width="100%" height="100%"></a>
																<div style="clear:both;"></div>
																</div>
															</div>
															<div style="width:100%; height:65px; float:left; background:#20201f;">
																	<div style=" width:115px;text-align:center; float:left;">
																	<a href="#" style=" text-decoration:none; padding:0px 27px; text-align:center; float:left; line-height:65px; font-family: Lato; color:#FFF; font-size:17.5px; font-weight:bold; text-transform:uppercase; text-shadow:0px 2px #000; letter-spacing:1px; background:url(http://www.cxohonour.com/images/border.jpg) no-repeat right">home</a>
																	</div>
														  </div> 
															...
															<div style="width:80%; float:left; height:80px;">
																	<span style="float:left; margin:15px 12px 0px 0px; display:block;"><img src="http://www.cxohonour.com/images/logo3.png" alt="" width="41" height="41"></span>
																  ...
																  <a href="http://www.cxohonour.com/contact_us.php" style="float:left; width:50%; margin:0px; display:block; text-transform:uppercase; font-family:Source Sans Pro; color:#616161;">Send us your question</a>
															  </div>
															<div style="width:170px; float:right; margin-top:22px;">
																<a href="http://www.linkedin.com/company/cio-choice-singapore/" target="_blank"><img width="30" height="31 " alt="" src="http://www.cxohonour.com/images/linkedin.png"></a>
																<a href="https://twitter.com/CIOCHOICE_SG" target="_blank"><img width="30" height="31 " alt="" src="http://www.cxohonour.com/images/twitter.png"></a>
																<a href="https://plus.google.com/+CiochoiceSg1/posts" target="_blank"><img width="30" height="31 " alt="" src="http://www.cxohonour.com/images/google_plus.png"></a>
																<a href="https://www.facebook.com/ciochoice.sg" target="_blank"><img width="30" height="31 " alt="" src="http://www.cxohonour.com/images/facebook.png"></a>
																<a href="http://www.youtube.com/user/CIOCHOICEsingapore" target="_blank"><img width="30" height="31 " alt="" src="http://www.cxohonour.com/images/play.png"></a>
															</div>
...
';
	...
	function email_to_vendor_signup($registration_name , $registration_email ,$web_url,$registration_type,$pass,$str) {
		...
		$mail->WordWrap = 500;      
		$mail->isHTML(true);                                  // Set email format to HTML
		 $confirm_url="<a  href='http://www.cxohonour.com/vendor_accepted.php?id=".$str."'>click here to activate your account</a>";
		$mail->Subject = 'Congratulations! Your Have Registered With CIO Honour';
		$mail->Body    = '
														...
														<div style="float:left; width:100%; margin:0px 0px 25px 0px; background:white; box-shadow:0px 2px 5px #7d7c7c;">
															...
															<div style="width:100%; float:left; padding:20px 0px; text-align:center;">
															  ...
															  <p style=" float:left; width:86%; display:block; font-family:Source Sans Pro; line-height:20px; margin:15px 7% 0% 7%; padding:0px; font-size:18px; font-weight:bold;">1. Company Email Address</p><br>
																		...
																		<p style=" float:left; width:86%; display:block; font-family:Source Sans Pro; line-height:20px; margin:5px 7% 0% 7%; padding:0px; font-size:15px; font-weight:400;">'. $pass.'</p>
															  <div style="float:left; width:90%; margin:30px 5% 0px 5%;">
																			<a href="http://www.cxohonour.com/vendor_accepted.php?id='.$str.'" style="width:100%; line-height:22px; padding:15px 0px; text-align:center; text-shadow:0px 2px #4b0e0e; float:left; color:#FFF; font-family:Lato; font-weight:bold; font-size:16px; text-decoration:none; border-radius:5px; text-transform:uppercase; letter-spacing:1px; background: -webkit-linear-gradient(#e63535, #c11e1e); /* For Safari 5.1 to 6.0 */ background: -o-linear-gradient(#e63535, #c11e1e); /* For Opera 11.1 to 12.0 */ background: -moz-linear-gradient(#e63535, #c11e1e); /* For Firefox 3.6 to 15 */ background: linear-gradient(#e63535, #c11e1e); /* Standard syntax */">Please click here to activate your account</a>
																		</div>
														  </div>
															<div style="float:left; width:100%;">
