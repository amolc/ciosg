			...
			if($_FILES["file"]["name"] != "")
			{
				...
				&& in_array($extension, $allowedExts))
				{
				  if ($_FILES["file"]["error"] > 0)
					...
					$sql   = "insert into awards(award_name,award_company,award_industry,award_image,award_insert_date)
					values
					('$award_name','$award_company','$award_industry','$award_image','$current_date')";
