	...
	<div class="col-md-12">
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit")
			{
				...
				$sql   = "insert into category(cat_name,cat_description) values('$category_name','$category_description')";
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="category_name"  placeholder=" " required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<textarea class="form-control" id="field-1" name="category_description"  placeholder=" " required></textarea>
						</div>
					</div>
