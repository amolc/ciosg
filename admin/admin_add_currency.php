	...
	<div class="col-md-12">
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit")
			{
				...
				$sql   = "insert into currency(country_code,currency_label,conversion_rate) values('$country_code','$currency','$conversion_rate')";
				...
				$event_id = mysql_insert_id();
					...
					if($query)
					{
						echo "Currency Added Successful";
					}
					else 
					{
						echo "error";
					...
					if(empty($error))
					{
				      ...
				      echo'<script>window.location.replace("admin_all_currency.php?add=ok");</script>';	
			}
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="country_code"  placeholder=" " required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="currency" placeholder=" " required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="conversion_rate" placeholder=" " required>
						</div>
					</div>
