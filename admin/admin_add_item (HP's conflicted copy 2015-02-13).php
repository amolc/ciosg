	...
	<div class="col-md-12">
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit")
			{
				...
				$sql   = "insert into item(catID,item_name,item_price,item_description) values('$category_name','$category_description')";
				...
				$event_id = mysql_insert_id();
					...
					if(empty($error))
					{
				      ...
				      echo'<script>window.location.replace("admin_all_category.php?add=ok");</script>';	
			}
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="item_price"  placeholder=" " required>
						</div>
					</div>
					<div class="form-group">
