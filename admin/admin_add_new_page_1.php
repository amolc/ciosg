				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$status = "pending";
							...
							$sql   = "insert into pages(page_name,page_description,page_insert_date) values ('$page_title','$Page_description','$page_insert_date')";
							$query = mysql_query($sql);
							if($query)
							{
								
								echo'<script>window.location.replace("admin_all_pages.php?add=ok");</script>';	
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
								<textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="Page_description" id="tour_overview" required></textarea>
							</div>
						</div>
