		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php 
					...
					{
						$title = mysql_real_escape_string($_POST['tab_title']);
						$data = addslashes($_POST['tab_data']);						
						$page_id = mysql_real_escape_string($_POST['page_id']);
										
							$sql   = "insert into pages_tab(tab_name,tab_data,page_id) values ('$title','$data','$page_id')";
							$query = mysql_query($sql);
							if($query)
							{
								
								echo'<script>window.location.replace("admin_page_tabs.php?id='.$page_id.'&add=ok");</script>';	
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Tab Title</label>

							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="tab_title" id="title" placeholder="Tab Title" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
                                                        ...
                                                        include("plugin/fckeditor/fckeditor.php") ;
                                                          ...
                                                          $oFCKeditor = new FCKeditor('tab_data') ;
						...
						<input type="hidden" name="page_id" value="<?php echo $_id; ?>" />
