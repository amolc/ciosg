			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$left = mysql_real_escape_string($_POST['left_column']);
						...
						$type = "tab";
							...
							if($query)
							{
								...
								echo'<script>window.location.replace("admin_tab_pages.php?add=ok");</script>';
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<!--<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
								<textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="left_column"  required></textarea>
							</div>
