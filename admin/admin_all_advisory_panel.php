		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					<td>'.$row['advisory_name'].'</td>
					<td>'.$row['advisory_desination'].'</td>
					<td>'.$row['advisory_description'].'</td>
					<td><a href="admin_edit_advisory_panel .php?id='.$row['advisory_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_advisor_delete.php?id='.$row['advisory_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left"  onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
