...
echo '<h2 style="color:red">Award Deleted</h2>'; 
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green">Award Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Award Added</h2>'; 
}
 ?>
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td>'.$row['award_company'].'</td>
					<td>'.$row['award_industry'].'</td>
					<td><a href="admin_edit_award.php?id='.$row['awardID'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
