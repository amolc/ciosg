...
echo '<h2 style="color:green">Category Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Category Added</h2>'; 
}
 ?>
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td><a href="admin_edit_category.php?id='.$row['catID'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_category.php?id='.$row['catID'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
