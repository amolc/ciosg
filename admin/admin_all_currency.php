...
echo '<h2 style="color:red">Currency Deleted</h2>'; 
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green">Currency Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Currency Added</h2>'; 
}
 ?>
<br />
...
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['curr_ID'].'">
				
					<td>'.$row['curr_ID'].'</td>
					<td>'.$row['country_code'].'</td>
					<td>'.$row['currency_label'].'</td>
					<td>'.$row['conversion_rate'].'</td>
					<td><a href="admin_edit_currency.php?id='.$row['curr_ID'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_currency.php?id='.$row['curr_ID'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
