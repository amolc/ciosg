...
echo '<h2 style="color:red">Item Deleted</h2>'; 
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green">Item Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Item Added</h2>'; 
}
 ?>
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td><a href="admin_edit_item.php?id='.$row['item_ID'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_item.php?id='.$row['item_ID'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
