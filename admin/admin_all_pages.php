...
/*
*
*@author:			developer<developer@day7.co>
...
<h2>All Pages</h2>
<div style="float:right"><a href="admin_column_pages.php"><button type="button" class="btn btn-primary">Column Pages</button></a>&nbsp;<a href="admin_tab_pages.php"><button type="button" class="btn btn-orange">Tab Pages</button></a>&nbsp;<a href="admin_add_new_page.php"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />
<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Page Deleted</h2>';
}
if(isset($_REQUEST['add'])){
echo '<h2 style="color:green;">Page Added</h2>';
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green;">Page Updated</h2>'; 
}
...
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['page_id'].'">
				    <td>'.$row['page_id'].'</td>
					<td>'.$row['page_name'].'</td>					
					<td>'.$row['page_insert_date'].'</td>
					<th><a target="_blank" href="../view_page.php?id='.$row['page_id'].'" class="btn btn-info">							
							Preview
						</a></th>
					<td><a href="admin_edit_page.php?id='.$row['page_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_page.php?id='.$row['page_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
	...
	<tfoot>
		<tr>
		    <th>ID</th>
			<th>Page Title</th>
			<!--<th>Page Description</th><td>'.$row['page_description'].'</td>-->
			<th>Create Date</th>
			<th>Preview</th>
			<th>Edit</th>
			<th>Delete</th>
