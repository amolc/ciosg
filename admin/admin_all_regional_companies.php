...
<head>
	...
	<title>Regional Companies</title>
...
<h2>All Regional Comapnies</h2>
<?php
if(isset($_REQUEST['del'])){
echo '<h2 style="color:red">Regional Company Deleted</h2>'; 
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green">Regional Company Updated</h2>'; 
}if(isset($_REQUEST['add'])){
echo '<h2 style="color:green">Regional Company Added</h2>'; 
}
 ?>
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['id'].'">
					...
					<td><a href="admin_edit_regional_company.php?id='.$row['rID'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_regional_company.php?id='.$row['rID'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
