<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$result = mysql_query("SELECT * FROM about WHERE abt_type='community'");
...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="admin_all_pages.php">Page</a></strong>
				</li>
			...
			<div class="panel-body">
				...
				<?php
					if($_POST['submit'] == 'submit')
					{
						 ...
						 $abt_description = addslashes($_POST['abt_description']);

                        $sql   = "Update about SET
						   abt_description = '$abt_description'
							where abt_type = 'community'
							";
							$query = mysql_query($sql) or die (mysql_error());
							if($query)
							{
								echo'<script>window.location.replace("admin_cio_choice_community.php?edit=ok");</script>';
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
                              ...
                              <?php
                                                        include("plugin/fckeditor/fckeditor.php") ;
                                                          ...
                                                          $oFCKeditor = new FCKeditor('abt_description') ;
                                                          ...
                                                          $oFCKeditor->Value		=  $row['abt_description'];
                                                          $oFCKeditor->Create() ;
                                                          ?>
                            </div>
