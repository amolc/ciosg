<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from category where catID = '$id'")or die (mysql_error());
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				<input type="hidden" class="form-control"  name="catID"  value="<?php echo $row['catID']; ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="category_name"  value="<?php echo $row['cat_name']; ?>">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Category Description</label>

						<div class="col-sm-5">
							<textarea class="form-control" id="field-1" name="category_description"  placeholder=" " required><?php echo $row['cat_description']; ?></textarea>
						</div>
					</div>
					<div class="form-group">
