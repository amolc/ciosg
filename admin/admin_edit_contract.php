<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from contract where contract_id = '$id'")or die (mysql_error());
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$current_date = date("m/d/Y", $today_date);
					...
					echo "<h1>Updated</h1>";
					echo'<script>window.location.replace("admin_all_contracts.php?edit=ok");</script>';
				...
				<input type="hidden" class="form-control"  name="contractID"  value="<?php echo $row['contract_id']; ?>">
				
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Company Name</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="company_name"  value="<?php echo $row['company_name']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="city" value="<?php echo $row['city']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="country"  value="<?php echo $row['country']; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">EmailID</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="emailID" value="<?php echo $row['emailID']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="website" value="<?php echo $row['website']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="designation" value="<?php echo $row['designation']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="add1" value="<?php echo $row['address1']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="add2" value="<?php echo $row['address2']; ?>">
						</div>
					</div>
					
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Contact Name</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="contact_name" value="<?php echo $row['contact_name']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="phone_number" value="<?php echo $row['phone_number']; ?>">
						</div>
					</div>
