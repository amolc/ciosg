<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$result = mysql_query("SELECT * FROM faq WHERE faq_id=$id");
			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$faq_id = mysql_real_escape_string($_POST['id']);
							
							
							$sql   = "Update faq SET 
							faq_heading = '$faq_title',
							...
							if($query)
							{								
								echo'<script>window.location.replace("admin_show_faq.php?edit=ok");</script>';								
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="faq_title" id="title" value="<?php echo $row['faq_heading']; ?>" />
							</div>
						</div>
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
							 ...
							 <?php
                                                        include("plugin/fckeditor/fckeditor.php") ;
                                                          ...
                                                          $oFCKeditor->Value		=  $row['faq_description'];
                                                          $oFCKeditor->Create() ;
                                                          ?>
