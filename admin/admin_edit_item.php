<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from item where item_ID = '$id'")or die (mysql_error());
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$item_ID = mysql_real_escape_string($_POST['item_ID']);
					...
					echo "<h1>Updated</h1>";
					echo'<script>window.location.replace("admin_all_items.php?add=ok");</script>';
				...
				<input type="hidden" class="form-control"  name="item_ID"  value="<?php echo $row['item_ID']; ?>">
					...
					<div class="form-group">
						...
						<?php $query1=mysql_query("select catID,cat_name from category");?>
				
						<div class="col-sm-5">
							<select name="category" onChange="get_item(this.value)" style="height:35px; width:300px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="item_name"  value="<?php echo $row['item_name']; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Item Price</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="item_price"  value="<?php echo $row['item_price']; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Item Description</label>

						<div class="col-sm-5">
							<textarea class="form-control" id="field-1" name="item_description"  placeholder=" " required><?php echo $row['item_description']; ?></textarea>
						</div>
					</div>
					<div class="form-group">
