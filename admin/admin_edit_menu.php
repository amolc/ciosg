			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$Page_id = mysql_real_escape_string($_POST['id']);
							...
							menu_name = '$title',
							menu_link = '$link'
							where menu_id = '$Page_id'
							";
							$query = mysql_query($sql) or die (mysql_error());
							if($query)
							{								
								echo'<script>window.location.replace("admin_menu.php?edit=ok");</script>';						
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="title" id="title" value="<?php echo $row['menu_name']; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="link" id="title" value="<?php echo $row['menu_link']; ?>" />
							</div>
						</div>
