<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from parent_company where pID = '$id'")or die (mysql_error());
...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<strong>Edit Parent Company</strong>
				</li>
			</ol>
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$pID = mysql_real_escape_string($_POST['pID']);
					...
					echo "<h1>Updated</h1>";
					echo'<script>window.location.replace("admin_all_parent_companies.php?add=ok");</script>';
				...
				<input type="hidden" class="form-control"  name="pID"  value="<?php echo $row['pID']; ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="company_name"  value="<?php echo $row['name']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="domain_name"  value="<?php echo $row['domain_name']; ?>">
						</div>
					</div>
