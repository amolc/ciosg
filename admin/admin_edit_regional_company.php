<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from regional_company where rID = '$id'")or die (mysql_error());
...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<strong>Edit Regional Company</strong>
				</li>
			</ol>

			<h2>Edit Regional Company</h2>
			<br />
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$rID = mysql_real_escape_string($_POST['rID']);
					$sql   = "update regional_company set
					name = '$company_name', 
