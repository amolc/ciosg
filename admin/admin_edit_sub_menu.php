<?php
	...
	if(isset($_SESSION['admin'])){
		...
		$id = $_REQUEST['id'];
		$pid = $_REQUEST['pid'];
		$result = mysql_query("SELECT * FROM sub_menu WHERE sub_id=$id");
...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="admin_sub_menu.php?id=<?php echo $pid; ?>">Sub Menu</a></strong>
				</li>
			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$parent_id = mysql_real_escape_string($_POST['pid']);
							...
							if($query)
							{	 							
								echo'<script>window.location.replace("admin_sub_menu.php?id='.$parent_id.'&edit=ok");</script>';							
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Menu Title</label>

							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="title" id="title" value="<?php echo $row['sub_name']; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="link" id="title" value="<?php echo $row['sub_link']; ?>" />
							</div>
						</div>
						...
						<input style="margin-left: -190px;margin-top: 10px;" type="submit" name="submit" value="submit" class="btn btn-info ok" />
