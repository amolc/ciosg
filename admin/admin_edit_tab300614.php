		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php 
					...
					{
						$tab_title = mysql_real_escape_string($_POST['tab_title']);
						$data= mysql_real_escape_string($_POST['tab_data']);						
						$tab_id = mysql_real_escape_string($_POST['id']);
							
							
							$sql   = "Update pages_tab SET 
							tab_name = '$tab_title',
							tab_data= '$data'							
							where tab_id = '$tab_id'
							";
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input style="margin-left: 20px;" type="text" data-validate="required" data-message-required="This is  required field."  class="form-control" name="tab_title" id="title" value="<?php echo $row['tab_name']; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
								<textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="tab_data" id="tour_overview" required><?php echo $row['tab_data']; ?></textarea>
							</div>
