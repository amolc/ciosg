	...
	<div class="col-md-12">
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$name = explode(" ",mysql_real_escape_string($_POST['name']));
				...
				$sql   = "update all_users set
					...
					echo "<h1>Updated</h1>";
					echo'<script>window.location.replace("admin_dashboard.php?add=ok");</script>';
					//header('Location:admin_all_parent_companies.php?edit=ok');
				...
				<input type="hidden" class="form-control"  name="registration_ID"  value="<?php echo $row['registration_id']; ?>">
									
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Name</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="name"  value="<?php echo $row['firstname']." ".$row['lastname']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="company"  value="<?php echo $row['company']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="company_address"  value="<?php echo $row['company_address']; ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="password"  value="<?php echo $row['password']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="mobile_number"  value="<?php echo $row['mobile_number']; ?>">
						</div>
					</div>
