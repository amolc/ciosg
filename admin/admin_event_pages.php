...
<h2>All Pages</h2>
<div style="float:right"><a href="admin_add_new_event_page.php"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['page_id'].'">
					...
					<td><a href="admin_edit_event_page.php?id='.$row['page_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_event_page.php?id='.$row['page_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
