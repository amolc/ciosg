...
//                                                echo "Stored in: " . "landing_images/ict_vendor/" . $target_path;
                                            } else
                                            {
                                                $fileData = pathinfo(basename($_FILES["file"]["name"]));
                                                $fileName = uniqid() . '.' . $fileData['extension'];
                                                $target_path = 'landing_images/ict_vendor/' . $fileName;
                                                move_uploaded_file($_FILES["file"]["tmp_name"], $target_path);
//                                                echo "Stored in: " . "landing_images/ict_vendor/" . $_FILES["file"]["name"];
                                            }
                                        }
                                        ...
                                        $result = mysql_query("SELECT id FROM cio_landing");
                                ...
                                <form role="form" action="<?php $_SERVER["PHP_SELF"]; ?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="field-1" name="title" placeholder="Title " required>
                                        </div>
                                    </div>
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="field-1" name="description" placeholder="Link ">
                                        </div>
                                    </div>
