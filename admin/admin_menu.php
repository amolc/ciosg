...
<h2>Menu</h2>
<div style="float:right"><a href="add_new_menu_link.php"><button type="button" class="btn btn-success">Add New Menu</button></a></div>
<br />
<br />
<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Menu Deleted</h2>';
}
if(isset($_REQUEST['add'])){
echo '<h2 style="color:green;">Menu Added</h2>';
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green;">Menu Updated</h2>'; 
}
...
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['menu_id'].'">
				   
									
					<td>'.$row['menu_name'].'</td>
					<td>'.$row['menu_link'].'</td>
					<td><a href="admin_sub_menu.php?id='.$row['menu_id'].'" class="btn btn-info">							
							Sub Menu
						</a>
					</td>
					<td><a href="admin_edit_menu.php?id='.$row['menu_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_menu.php?id='.$row['menu_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
