<?php
	...
	{
	$_id = $_REQUEST['id'];	
		$result = mysql_query("SELECT * FROM pages WHERE page_id=$_id");
...
<div class="main-content">
	...
	<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="admin_tab_pages.php">Tab Pages</a></strong>
				</li>
				<li class="">
					<strong><a href="admin_tab_pages.php?id=<?php echo $_id; ?>"><?php echo $row['page_name']; ?></a></strong>
				</li>
					<li class="active">
							<strong>Tabs</strong>
					</li>
...
<h2>Tabs</h2>
<div style="float:right"><a href="admin_add_new_tab.php?id=<?php echo $_id; ?>"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />

<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Tab Deleted</h2>';
}
if(isset($_REQUEST['add'])){
echo '<h2 style="color:green;">Tab Added</h2>';
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green;">Tab Updated</h2>'; 
}
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="">
				    <td>'.$_id.'</td>
					<td><a target="_blank" href="../view_tab.php?id='.$row['tab_id'].'">'.$row['tab_name'].'</a></td>					
					
					<td><a href="admin_edit_tab.php?id='.$row['tab_id'].'&pid='.$_id.'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_page_tab.php?id='.$row['tab_id'].'&pid='.$_id.'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left">
							Delete
						</a>
					</td>
				</tr>
