...
$(document).ready(function(){
	...
	/**
			* cio-choice
			*@author:	dev.qasim@day7.co
			*@date:	19 March 2014 11:15 AM GM+5
			*/
			...
			{
			//alert('column');
			window.location.replace("admin_column_pages.php");
			}
			if (page_type == 'tab')
			{
			//alert('tab');
			window.location.replace("admin_tab_pages.php");
			}
			});
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<input style="margin-left: -211px;margin-top: 10px;" type="button" id="type_submit" value="submit" class="btn btn-info ok" />
