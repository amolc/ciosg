		...
		{  
			...
			echo'
				<tr class="odd gradeX" id="'.$row['faq_id'].'">
					...
					<td>
						<a href="admin_delete_faq.php?id='.$row['faq_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
							Delete
						</a>
					</td>
				</tr>
