	...
	<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<a href="admin_dashboard.php"><i class="entypo-home"></i>Home</a>
					...
					<li class="active">
							<strong>Tab Pages</strong>
					</li>
					</ol>
			
<h2>Tab Pages</h2>
<div style="float:right"><a href="admin_add_new_tab_page.php"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />

<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Tab Page Deleted</h2>';
}
if(isset($_REQUEST['add'])){
echo '<h2 style="color:green;">Tab Page Added</h2>';
}
if(isset($_REQUEST['edit'])){
echo '<h2 style="color:green;">Tab Page Updated</h2>'; 
}
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['page_id'].'">
					...
					<td><a href="admin_page_tabs.php?id='.$row['page_id'].'" class="btn btn-primary">							
							Tabs
						</a>
					</td>
					<td>'.$row['page_insert_date'].'</td>
					<td><a href="admin_edit_tab_page.php?id='.$row['page_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_tab_page.php?id='.$row['page_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left">
							Delete
						</a>
					</td>
				</tr>
