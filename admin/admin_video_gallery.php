...
<h2>Video Gallery</h2>
<div style="float:right"><a href="admin_add_video_gallery.php"><button type="button" class="btn btn-success">Add New</button></a></div>
<br />
<br />

<?php if(isset($_REQUEST['del'])){
echo '<h2 style="color:red;">Video Gallery Deleted</h2>';
}
if(isset($_REQUEST['edit'])){ 
echo '<h2 style="color:green;">Video Gallery Updated</h2>';
}
if(isset($_REQUEST['add'])){ 
echo '<h2 style="color:green;">Video Gallery Saved</h2>';
}
?>
...
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['gallery_id'].'">				    
					<td>'.$row['title'].'</td>
					
				 
				<td><a href="admin_gallery_videos.php?id='.$row['gallery_id'].'" class="btn btn-info">							
								Videos
				</a>
				</td>
											
		
				<td><a href="admin_edit_video_gallery.php?id='.$row['gallery_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
						<i class="entypo-pencil"></i>
						Edit
					</a>
				</td>
				<td>
					<a href="admin_delete_video_gallery.php?id='.$row['gallery_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm(\'Are you sure?\');">
						Delete
					</a>
				</td> 
			</tr>
