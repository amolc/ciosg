...
*@author:			developer<developer@day7.co>
*@Date & Time:		28-march-2014 GM +5
*@Modified Date:	28-march-2014 GM +5 
*/
$result = mysql_query("SELECT
		...
		{ 
			...
			echo'
				<tr class="odd gradeX" id="'.$row['landing_panel_id'].'">
					<td>'.$row['landing_panel_id'].'</td>
					<td>'.$row['landing_panel_type'].'</td> 
					<td>'.$row['landing_panel_message'].'</td>
					<td>'.$row['landing_panel_date'].'</td>
					<td><a href="admin_edit_landing_panel.php?id='.$row['landing_panel_id'].'" class="btn btn-default btn-sm btn-icon icon-left edit_tour_list">
							<i class="entypo-pencil"></i>
							Edit
						</a>
					</td>
					<td>
						<a href="admin_delete_landing_panel.php?id='.$row['landing_panel_id'].'" style="padding-left: 10px;" class="delete btn btn-danger btn-sm btn-icon icon-left">
							Delete
						</a>
					</td>
				</tr>
