...
$res = mysql_query("select * from cio_message_board") or die();
...
?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="massage_board.php">CIO Message Board</a></strong>
				</li>
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$message = addslashes($_POST['message']);
							...
							$sql   = "update cio_message_board set cio_message = '$message'";
							$query = mysql_query($sql);
							if($query)
							{
								
								echo'<script>window.location.replace("cio_massage_board.php?add=ok");</script>';
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
							 ...
							 <?php
                                                        include("plugin/fckeditor/fckeditor.php") ;
                                                          ...
                                                          $oFCKeditor->Value		=  $row['cio_message'];
                                                          $oFCKeditor->Create() ;
                                                          ?>
                                                        </div>
