...
CKEDITOR.plugins.setLang( 'a11yhelp', 'gl', {
	...
	legend: [
		...
		items: [
			...
			legend: 'Dentro dun cadro de diálogo, prema a tecla TAB para despdeveloperrse ao campo seguinte do cadro de diálogo, prema MAIÚS + TAB para despdeveloperrse ao campo anterior, prema INTRO para presentar o cadro de diálogo, prema a tecla ESC para cancelar o diálogo. Para os diálogos que teñen varias páxinas, prema ALT + F10 para navegar á lapela da lista. Despois pasar á seguinte lapela con TAB ou FRECHA DEREITA. Para ir á lapela anterior con SHIFT + TAB ou FRECHA ESQUERDA. Prema ESPAZO ou INTRO para seleccionar a lapela da páxina.'
		},
