			...
			<div id="sidebar-wrapper">
				<div id="MainMenu">
					  <div class="list-group panel">
						...
						<a data-parent="#MainMenu"  class="edit_List1 list-group-item list-group-item-primary collapsed" href="vendor/show_vendors">Manage Vendor</a>
						...
						<a href="manage/manage_category" data-parent="#MainMenu"  class="edit_List1 list-group-item list-group-item-primary collapsed">Manage Category</a>
						...
						<a href="manage/manage_company" data-parent="#MainMenu"  class="edit_List1 list-group-item list-group-item-primary collapsed" >Manage Company</a>
								...
								<form class="form-inline pull-right" role="form">
											  <div class="form-group">
												<div class="input-group">
												  ...
												  <input type="email" class="form-control" id="exampleInputEmail2" placeholder="Search Courses">
												</div>
											  </div>
											...
											<div class="clsForm">
												<div class="row">
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="Enter first name " class="form-control ">
													</div>
																 
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="Enter last name " class="form-control ">
													</div>													
												</div>
												
												<div class="row">
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="Enter corporate email address " class="form-control ">
													</div>
																 
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="Enter company " class="form-control ">
													</div>													
												</div>
												
												<div class="row">
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="password" style="height:50px;" placeholder="Enter password " class="form-control ">
													</div>
																 
													<div style="margin-bottom:15px;" class="col-md-6">
														<input type="text" style="height:50px;" placeholder="*Enter mobile number  " class="form-control ">
													</div>													
												</div>
