...
class CI_Pagination {
	...
	var $base_url			= 'http://192.168.1.35/dropbox/pagignation'; // The page we are linking to
	...
	var $last_link			= 'Last';
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="dataTables_paginate paging_bootstrap pagination"><ul>';
