<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from currency where curr_ID = '$id'")or die (mysql_error());
	...
	<div class="col-md-12">
		...
		<?php
			 ...
			 if($_POST['upload_button'] == "Submit")
			 {
				...
				$conversion_rate = mysql_real_escape_string($_POST['conversion_rate']);
				$curr_ID = mysql_real_escape_string($_POST['curr_ID']);
					...
					echo "<h1>Updated</h1>";
					echo'<script>window.location.replace("admin_all_currency.php?edit=ok");</script>';
				...
				<input type="hidden" class="form-control"  name="curr_ID"  value="<?php echo $row['curr_ID']; ?>">
					
					
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Country Code</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="country_code"  value="<?php echo $row['country_code']; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="currency"  value="<?php echo $row['currency_label']; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Conversion Rate</label>

						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="conversion_rate"  value="<?php echo $row['conversion_rate']; ?>">
						</div>
					</div>
					<div class="form-group">
