<?php
 ...
 $id = $_REQUEST['id'];
 $res = mysql_query("select * from all_users where registration_ID = '$id'")or die (mysql_error());
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
				...
				<input type="hidden" class="form-control"  name="item_ID"  value="<?php echo $row['registration_ID']; ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<label for="field-1" class="control-label"><?php echo $row['firstname']." ".$row['lastname']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['company']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['company_address']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['emailID']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['password']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['mobile_number']; ?></label>
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Registration Type</label>

						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['registration_type']; ?></label>
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Registration Status</label>

						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo $row['registration_status']; ?></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<label for="field-1" class="control-label"><?php echo date('d/m/Y',$row['registration_insert_date']); ?></label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<!--<button type="submit" class="btn btn-default">Submit</button>-->
							<!--<input type="submit" name="upload_button" class="btn btn-default" value="Edit User">-->
							<a href="admin_edit_user_profile.php?id=<?php echo $row['registration_id']?>"class="btn btn-default">Edit User</a>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="admin_dashboard.php"class="btn btn-default">OK</a>
						</div>
					</div>
