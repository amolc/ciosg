...
ob_start();
    ...
    $config['callback_url']         =   'http://www.cio-choice.sg/demo.php?email='.$email.'';
     // $config['callback_url']         =   'http://staging.cio-choice.sg/advisory_panel.php';
      $config['linkedin_access']      =   '75iy9759ka2tc1';
    $config['linkedin_secret']      =   'tfvcnVBYVZGsXYvO';   
 ...
 $linkedin->getRequestToken();
    $linkReqTocken = $linkedin->request_token;
   ...
   if (isset($_REQUEST['oauth_verifier'])){
        ...
        $linkedin->request_token    =  $linkReqTocken;
...
//                                 die();
    ...
    $xml_response = $linkedin->getProfile("/people/~:(id,first-name,last-name,email-address,headline,picture-url)");
// if($xml_response) 
// {
...
//                                 print_r($_SESSION);
//                                    print_r($result);
//					      echo $email = $registration_email.'<br>Aashish<br>'.$_GET['email'];die();
