...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif;">
  <tr>
    <td><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="116" align="left" valign="top" style=" border-bottom:#000000 solid 1px;">
  ...
  <tr>
    ...
    <td width="117" height="116" align="right" valign="top"><span style="float:right; width:117px; display:block; margin:0px; height:116px;"><img width="117" height="116" src="'.$web_url.'/images/Landing_logo.jpg"></span></td>
      ...
      <tr>
        <td align="left" valign="middle" height="40"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;"> <br />4) IMPORTANT NOTES:</h2></td>
      </tr>
	  
	   <tr>
        <td height="30" align="left" valign="middle"><strong>a. Participation Fees.</strong></td>
      </tr>
	   <tr>
        <td align="left" valign="top">
		<ul>
      <li>Registration Fee: <u><strong>US$1,000</strong></u> for each category of product, service and/or solution submitted.<br/></li>
      <li>License Fee (per category), applicable <u><strong>ONLY</strong></u> when the specific category of product, service and/or 
solution registered is conferred “CIO CHOICE 2014”. <br/><br/>
- <u><strong>US$12,000</strong></u> for company with local sales revenue > USD 15M <br/> <br/>
- <u><strong>US$8,000</strong></u> for company with local sales revenue &lt;= USD 15M<br/></li>	
	
	<li>All fees are exclusive of local taxes.<br/></li>
	<li>Payment Terms: Net 30 days from Invoice date.<br /></li>
    </ul>
	</td>
      </tr>
      <tr>
        <td height="30" align="left" valign="middle"><strong>b. Order Summary.</strong></td>
      </tr>
            <tr>
                <table width="650" border="1" bordercolor="#C1C1C1" align="Center"  cellspacing="0" cellpadding="7" style="padding-bottom:20px;" >
                    <tbody>
                    <tr>
                            <th width="50" height="30" align="center"  valign="middle" style="margin:15px;"  ><strong>Item</strong></th>
                            <th width="400" height="30" align="center" valign="middle" style="margin:15px;" ><strong>Description</strong></th>
                            <th width="100" height="30" align="center" valign="middle" style="margin:15px;"><strong># of Categories</strong></th>
                            <th width="100" height="30" align="center" valign="middle" style="margin:15px;" ><strong>Final Price(USD)</strong></th>
                        </tr>
                         <tr>
                            <td width="50" height="30"   align="right" valign="top" >1</td>
                            <td width="400" height="30" align="left"  valign="top"   ><strong>Registration Fee </strong>(Due upon Registration Entry)</td>
                            <td width="100" height="30" align="center">&nbsp;</td>
                            <td width="100" height="30" align="center" >&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="50" height="30"   align="right" valign="top" >2</td>
                            <td width="400" height="30" align="left"  valign="top"   ><strong>License Fee  </strong>(Due only upon CIO CHOICE 2014 Recognition)</td>
                            <td width="100" height="30" align="center">&nbsp;</td>
                            <td width="100" height="30" align="center" >&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="50" height="30"   align="right" valign="top" ></td>
                            <td width="400" height="30" align="left"  valign="top"   ></td>
                            <td width="100" height="30" align="center"><strong>Total :</strong></td>
                            <td width="100" height="30" align="center" >&nbsp;</td>
                        </tr>
                    </tbody>
                </table>
	  ...
	  <tr>
        <td height="30" align="left" valign="middle" width="650" border="0" cellpadding="0" cellspacing="0"><strong>c. Please submit a scanned copy of the completed & duly signed Registration Form via email
to </strong><a href="mailto:registration@cio-choice.sg">registration@cio-choice.sg</a><br /></td>
      </tr>
	  <tr>
        <td height="30" align="left" valign="middle" width="650" border="0" cellpadding="0" cellspacing="0"><strong>d. Please send the cheque/ pay order/ demand draft to:</strong></td>
      </tr>
	   <tr>
        <td align="left" valign="top">
		<ul>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif;">
  ...
  <tr>
    ...
    <td width="117" height="116" align="right" valign="top"><span style="float:right; width:117px; display:block; margin:0px; height:116px;"><img width="117" height="116" src="'.$web_url.'/images/Landing_logo.jpg"></span></td>
	  ...
	  <tr>
        <td height="40" align="left" valign="middle" style="font-weight:bold;"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;">1.1 Articles &amp; Definitions</h2></td>
      </tr>
	   <tr>
        <td align="left" valign="top">
		<ul>
	   ...
	   <tr>
        <td height="40" align="left" valign="middle" style="font-weight:bold;"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;">1.2 Participation Fee</h2></td>
      </tr>
	   <tr>
        <td align="left" valign="top">
		<ul>
...
be published by the Organiser on its official website address at www.cio-choice.sg <br />
</li>
        </ul>
	</td>
      </tr>
	  ...
	  <tr>
	    <td height="40" align="left" valign="middle" style="font-weight:bold;"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;">1.3 Agreement </h2></td>
	    </tr>
	  <tr>
	    <td align="left" valign="top">
		<ul>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0" style=" font-family: Arial, Helvetica, sans-serif;">
	  ...
	  <tr>
	    <td height="30" align="left" valign="middle" style="font-weight:bold; font-size:16px;">The Programme</td>
	    </tr>
	   <tr>
...
the Trade Marks are reasonably likely to be sold before the expiry of the License.<br /><br /><br />
</p></td>
	     </tr>
		 
		 <tr>
	     <td align="left" valign="middle" height="40"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;">4.4 Limitations on Use / Right to Terminate</h2>
...
<br />
	     ...
	     <td align="left" valign="top">
	       ...
	       <tr>
	         <td height="25" align="left" valign="bottom" style="font-family: Arial, Helvetica, sans-serif;">Place, Date Company Name</td>
	         </tr>
	       <tr>
	       ...
	       <tr>
	         <td height="25" align="left" valign="bottom" style="font-family: Arial, Helvetica, sans-serif;">Signature</td>
	         </tr>
	       <tr>
	         <td height="70" align="left" valign="top">&nbsp;</td>
	         </tr>
	       ...
	       <tr>
	         <td height="25" align="left" valign="bottom" style="font-family: Arial, Helvetica, sans-serif;">Name (BLOCK CAPITALS), Title, Company Seal<br />
