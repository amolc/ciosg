                                            ...
                                            <div id="advisory_wrapper">
                                                <div class="get_in_touch" style="margin-top:15px;">
                                                  <div class="login_main fl"> 
													...
													$rpass =$_POST["rtype"];
													$time = now();
													$conn = mysql_connect('localhost','ciochoice', '10gXWOqeaf');
												   ...
												   '(registration_name,registration_email, 		   regist_mobile,registration_password,registration_type,login_type,registration_insert_date,registration_status) '.
												   'VALUES ("$name", "$email", "$mno", "$pass", "$rpass", "CIO", "email","26/12/2014", "accepted")';*/
												   
				$sql="insert into registration(registration_id,registration_name,registration_email,regist_mobile,registration_password,registration_type,login_type,registration_insert_date,registration_status) values('null''$name','$email','$mno','$emailID','$pass','CIO','email','25/12/2014','accepted')";								   
