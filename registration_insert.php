<?php
	...
	$registration_type = $_REQUEST['email'];
							...
							// $filter = explode("@",$registration_email); isset($_REQUEST['sent']
							// if(($filter[1] != "gmail.com") || ($filter[1] != "yahoo.com") ) {
							// $admin ='mark.devday7@day7.co';
							echo "dd".$registration_type;
