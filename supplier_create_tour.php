		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<?php
				...
				$result = mysql_query("SELECT id FROM tour");
										...
										{
											// echo "<h2>your payment status shows unpaid now please pay to continue</h2><a href='http://apps.day7.co/tourbookings/supplier/payment_booking.php'><button>Pay Now</button></a> ";
											echo "<h2>your payment status shows unpaid now please pay to continue</h2><a href='http://apps.day7.co/tourbookings/supplier/payment_booking.php'><button>Pay Now</button></a> ";
										}
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$status = "pending";
							...
							$price_customer_adult = ($commission_rate / $price_per_person)*100;
							$price_customer_child = ($commission_rate / $price_child)*100;
							//current date
							...
							$query = mysql_query($sql);
							 if($query){
								...
								// $tour_id_query = "SELECT * FROM tour ORDER BY id DESC LIMIT 1";
									...
									$tour_id = $row[0]; 
								$sql2   = "insert into tour_price(currency_id,tour_id,price_per_person,price_child,price_adult,price_customer_adult,price_customer_child,ishike,commission_rate,insert_date) values ('$currency_id','$tour_id','$price_per_person','$price_child','$price_adult','$price_customer_adult','$price_customer_child','false','$commission_rate','$insert_date')";
...
<br />
						...
						<input type="checkbox" class="maxtickets_enable_cb" name="opwp_wootickets">check box <br /> <br />
							...
							<input type="text" style="margin-left: 252px;width: 15%;display:none;" class="form-control" name="commission" id="commission" placeholder="5%">
